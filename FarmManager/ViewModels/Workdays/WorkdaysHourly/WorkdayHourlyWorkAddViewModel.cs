...
public class WorkdayHourlyWorkAddViewModel(IWorkdayService workdayService, IUnitOfWork unitOfWork) : BaseViewModel
{
    #region Properties

    public event Action<Workday>? RequestClose;
    public WorkdayHourlyWorkAddModel Model = new WorkdayHourlyWorkAddModel();
