...
public class WorkdayHarvestHourlyAddViewModel(IWorkdayService workdayService, IUnitOfWork unitOfWork) : BaseViewModel
{
    #region Properties

    public event Action<Workday>? RequestClose;
    public WorkdayHarvestHourlyAddModel Model = new WorkdayHarvestHourlyAddModel();
